...
import { BucketPosition } from '../../src/constants/BucketPosition';
import { Color } from '../../src/constants/Color';
import { Shape } from '../../src/constants/Shape';
...
describe('Guess Prompt', () => {
  ...
  it('shows guess prompt after 1 move', () => {
    ...
    cy.get(cySelector(CyLayer.GUESS_PROMPT)).contains('Continue Playing').click();
  });
